...
public class NotificationUtils {
    ...
    private NotificationUtils() {
        notificationManager =
                (NotificationManager)
                        Utils.getApp().getSystemService(NOTIFICATION_SERVICE);
    ...
    private Notification createNotificationByHoneycomb(String title, String content) {
        ...
        Notification.Builder builder =
                new Notification.Builder(Utils.getApp()); // 获取一个Notification构造器
    ...
    private Notification createNotificationByO(String channelId, String title, String content) {
        return new NotificationCompat.Builder(Utils.getApp(), channelId)
                ...
                .setLargeIcon(
                        BitmapFactory.decodeResource(
                                Utils.getApp().getResources(), R.drawable.ic))
                .setAutoCancel(true)
