package com.jieba.jieba_android.viterbi;
...
import com.jieba.jieba_android.CharacterUtil;
import com.jieba.jieba_android.Node;
import com.jieba.jieba_android.Pair;


public class FinalSeg {
    private static volatile FinalSeg singleInstance;
    ...
    private Map<Character, Double> start;
    private Map<Character, Map<Character, Double>> trans;
    private Map<Character, char[]> prevStatus;
