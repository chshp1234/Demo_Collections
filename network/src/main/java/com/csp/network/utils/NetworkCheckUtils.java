...
public class NetworkCheckUtils {
     ...
     * 初始化网络诊断服务
     */
    public NetworkCheckUtils(Context context, String domain, IOnNetPingListener theListener) {
        this.mDomain = domain;
    ...
    public void release() {
        synchronized (NetworkCheckUtils.class) {
