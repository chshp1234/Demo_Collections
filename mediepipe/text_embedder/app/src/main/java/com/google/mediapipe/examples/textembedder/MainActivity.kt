...
import com.google.mediapipe.examples.textembedder.databinding.ActivityTextEmbedderBinding

class MainActivity : AppCompatActivity(), TextEmbedderHelper.EmbedderListener {
    private lateinit var binding: ActivityTextEmbedderBinding
    private lateinit var textEmbedderHelper: TextEmbedderHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTextEmbedderBinding.inflate(layoutInflater)
