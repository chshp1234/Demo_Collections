...
import com.mediapipe.example.interactivesegmentation.databinding.ActivityInteractiveSegmentationBinding
import java.io.File
...
class MainActivity : AppCompatActivity(), InteractiveSegmentationHelper.InteractiveSegmentationListener {
    ...
    private lateinit var activityMainBinding: ActivityInteractiveSegmentationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding = ActivityInteractiveSegmentationBinding.inflate(layoutInflater)
