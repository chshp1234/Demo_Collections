...
import com.google.mediapipe.examples.imageembedder.databinding.ActivityImageEmbedderBinding

class MainActivity : AppCompatActivity(), ImageEmbedderHelper.EmbedderListener {
    private lateinit var binding: ActivityImageEmbedderBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityImageEmbedderBinding.inflate(layoutInflater)
