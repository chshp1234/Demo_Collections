...
import com.google.mediapipe.examples.languagedetector.databinding.ActivityLanguageDetectorBinding
import com.google.mediapipe.tasks.text.languagedetector.LanguageDetectorResult

class MainActivity : AppCompatActivity() {

    private var _activityMainBinding: ActivityLanguageDetectorBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _activityMainBinding = ActivityLanguageDetectorBinding.inflate(layoutInflater)
