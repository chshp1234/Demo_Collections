...
import com.google.mediapipe.examples.textclassifier.databinding.ActivityTextClassificationBinding
import com.google.mediapipe.tasks.text.textclassifier.TextClassifierResult

class MainActivity : AppCompatActivity() {

    private var _activityMainBinding: ActivityTextClassificationBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _activityMainBinding = ActivityTextClassificationBinding.inflate(layoutInflater)
