...
import com.google.mediapipe.examples.textclassifier.databinding.ItemClassificationTextClassificationBinding
...
class ResultsAdapter : RecyclerView.Adapter<ResultsAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemClassificationTextClassificationBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            ItemClassificationTextClassificationBinding.inflate(
