...
public class MaskableTextView extends AppCompatTextView {
    ...
    @ColorInt private int maskColor;
    @ColorInt private int originalColor;
    @ColorInt private int originalBgColor;
    private PorterDuff.Mode maskMode;
    private final PorterDuff.Mode DEFAULT_PORTERDUFF_MODE = PorterDuff.Mode.MULTIPLY;
    private final int DEFAULT_COLOR = R.color.click_bg;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        maskColor =
                array.getColor(
                        R.styleable.MaskableTextView_mask_color, context.getColor(DEFAULT_COLOR));
