 ...
 *
 * <p>TODO: Customize class - update intent actions, extra parameters and static helper methods.
 */
public class MyIntentService extends IntentService {
    // TODO: Rename actions, choose action names that describe tasks that this
    // IntentService can perform, e.g. ACTION_FETCH_NEW_ITEMS
    private static final String ACTION_FOO = "com.example.aidltest.action.FOO";
    private static final String ACTION_BAZ = "com.example.aidltest.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 =
            "com.example.aidltest.extra.PARAM1";
    private static final String EXTRA_PARAM2 =
            "com.example.aidltest.extra.PARAM2";
    ...
    /**
     * Starts this service to perform action Baz with the given parameters. If the service is
     * already performing a task this action will be queued.
     *
     * @see IntentService
     */
    ...
    private void handleActionFoo(String param1, String param2) {
        ...
        LogUtils.d("handleActionFoo: param1=" + param1 + " param2=" + param2);
    }

    /** Handle action Baz in the provided background thread with the provided parameters. */
    private void handleActionBaz(String param1, String param2) {
        // TODO: Handle action Baz
        LogUtils.d("handleActionBaz: param1=" + param1 + " param2=" + param2);
    }
}
